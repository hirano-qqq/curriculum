...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected static final String CONST_ELEMENT_NAME_REQUEST = "nameRequest";
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            // ←ここへ記述
        	EmployeeDao.ExecuteCase reqExecuteCase = null;


        	ems.getEmployeeData(reqExecuteCase,resEmployeeBean);
